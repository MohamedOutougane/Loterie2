...
namespace Loterie.Controllers
{
    public class SessionsController : Controller
    {
        ...
        public SessionsController(LoterieContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Draw,Date,Jackpot")] Session session)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Draw,Date,Jackpot")] Session session)
        {
            if (id != session.Id)
            {
                return NotFound();
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'LoterieContext.Session'  is null.");
            }
            var session = await _context.Session.FindAsync(id);
            if (session != null)
            {
