...
namespace Loterie.Controllers
{
    public class TicketsController : Controller
    {
        ...
        public TicketsController(LoterieContext context)
        {
            _context = context;
        }
        ...
        {
            var loterieContext = _context.Ticket.Include(t => t.Session);
            return View(await loterieContext.ToListAsync());
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'LoterieContext.Ticket'  is null.");
            }
            var ticket = await _context.Ticket.FindAsync(id);
            if (ticket != null)
            {
